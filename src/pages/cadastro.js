...
const Cadastro = function () {
    ...
    async function save() {
        setLoading(true)
        const baseURL = "https://church-admin-puc.azurewebsites.net/v1/CadastrarMembro"
        const baseURL_UPDATE = "https://church-admin-puc.azurewebsites.net/v1/AtualizarMembro"
        const headers = {
